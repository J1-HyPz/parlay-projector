  ...
  return (
    <article className="panel p-4">
      ...
      <a
        ...
        className="mt-2 block truncate py-1 text-sm text-white/60 transition hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-400/50"
      >
        {selection.fixture}
      </a>
